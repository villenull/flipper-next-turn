...
**Bluetooth · Navigation** &nbsp; | &nbsp; **Release v0.5** &nbsp; | &nbsp; **Flipper Zero + Android 8.0+**

### Download & install

**[⬇ Download the Android app](https://github.com/villenull/flipper-next-turn/releases/download/v0.5/flipper-now-debug.apk)** — one **Flipper Now** helper for both Now Playing and Now Turning. Open this link on your phone, download, and tap to install (it upgrades the old Now Playing helper in place).

**[⬇ Download the Flipper app (.fap)](https://github.com/villenull/flipper-next-turn/releases/download/v0.2/nav_turns-fw1.4.3-api87.1.fap)** · [All release files](https://github.com/villenull/flipper-next-turn/releases/tag/v0.5) · [Checksums](https://github.com/villenull/flipper-next-turn/releases/download/v0.4/SHA256SUMS)
...
5. **Pair each companion (one tap each).** Tap **2 · PAIR NOW PLAYING** and **3 · PAIR NOW TURNING** — the helper scans, picks the strongest match, saves it and starts. Confirm the pairing code on both screens. Open only the matching app on the Flipper first (one radio at a time). Confirm the matching pairing code on both devices (the phone popup sometimes hides in the notification shade — pull it down).
